...
class Model(nn.Module):
    ...
    def forward(self, x):
        ...
        feature_map_25, output_25 = self.gfe_two(feature_map, self.A_25) 
        ...
        feature_map_11, output_11 = self.gfe_three(feature_map_11, self.A_11) 
        feature_map_6, output_6 = self.gfe_four(feature_map_6, self.A_6)
         
   
       
        x = F.avg_pool2d(feature_map_25, feature_map_25.size()[2:])
    
        y = F.avg_pool2d(feature_map_11, feature_map_11.size()[2:])
        z = F.avg_pool2d(feature_map_6, feature_map_6.size()[2:])
