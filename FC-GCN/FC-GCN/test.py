...
# LOAD WEIGHT
# weights_path = work_dir + '/best_model_withoutpre.pt' # ön işlem adımı yok ağırlık dosyası 
weights_path = work_dir + '/best_model_withpre.pt' # ön işlem adımı var ağırlık dosyası 
